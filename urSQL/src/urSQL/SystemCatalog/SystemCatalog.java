...
/*-*-*-*-*-*-*-*-*-*-*Banderas*-*-*-*-*-*-*-*-*-*-*-*/
	...
	/**
	 * Sufijo que identifica los archivos de informaci�n de tabla
	 */
...
+	 * cantidad de columnas 
	...
	public void addDatabase(String database_name){
		//crea el file de la ubicaci�n de bases de datos 
	 ...
	 * 
	 * @return arreglo de bytes con la informaci�n
	 */
	...
	/**
	 * Crea un registro a partir de estos par�metros
	 * 
	...
	private byte[] addReferenceAux(String column1, String table2, String column2){
		...
		//regisros de bytes con el tama�o
     ...
     * 
     * @return true si esta dentro del �rbol y false
